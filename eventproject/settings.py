...
SECRET_KEY = 'django-insecure-^xay4&t(c%fl-&(g*3r_gx4zv%!7#cdy^lkp49@sa54kj(cuxb'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','eventapp','events','register','booking', 'crispy_forms',
]
...
SESSION_COOKIE_AGE = 1000  # Time in seconds
